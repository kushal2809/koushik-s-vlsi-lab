...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Koushik's VLSI Space" },
      {
        name: "description",
        content: "VLSI Physical Design portfolio and knowledge space by Koushik.",
      },
      { name: "author", content: "Koushik" },
      { property: "og:title", content: "Koushik's VLSI Space" },
      {
